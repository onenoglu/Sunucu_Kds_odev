    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
			$query = "SELECT COUNT(ariza.a_id) AS ariza_sayisi,ilce.ilce_adi,(SELECT COUNT(musteri.m_id) FROM musteri,ilce WHERE musteri.ilce_id=ilce.ilce_id AND ilce.ilce_adi='Buca' GROUP BY ilce.ilce_id) AS musteri_sayisi
